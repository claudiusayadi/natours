...
exports.imagesResizer = catchAsync(async (req, res, next) => {
...
exports.topFive = (req, res, next) => {
	...
	req.query.fields =
		'name,price,difficulty,ratingsAverage,ratingsQuantity,priceDiscount,summary,description,imageCover,images,';
	next();
};
...
exports.getToursWithin = catchAsync(async (req, res, next) => {
	...
	if (!lat || !lng)
		return next(
			new AppError(
				'Please provide correct coordinates in this format: lat,lng',
				400
			)
		);
